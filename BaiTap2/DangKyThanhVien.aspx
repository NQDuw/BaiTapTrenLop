...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="row  text-white border border-success bg-success">
                <div class="col-md-8 p-2 text-center">
                    Thông tin đăng ký
                </div>
                <div class="col-md-4 pt-2 text-center text-white border border-left border-success">
                    Hồ sơ đăng nhập
                </div>
            </div>
            <div class="row border border-right border-success">
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-3">
                            Tên đăng nhập
                ...
                <div class="col-md-4 border border-right border-success">
